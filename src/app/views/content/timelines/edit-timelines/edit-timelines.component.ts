...
@Component({
  selector: 'app-edit-timelines',
  templateUrl: './edit-timelines.component.html',
  styleUrls: ['./edit-timelines.component.css']
})
export class EditTimelinesComponent implements OnInit {
  id: any = "";
  ...
  ngOnInit(): void {
    this.slides[0] = {
      src: './assets/img/cards/Timelines.png',
    };
    this.slides[1] = {
