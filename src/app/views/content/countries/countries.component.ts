...
export class CountriesComponent implements OnInit {
  ...
  index(): void {
    ...
    this.contentService.getAllCountries(accountId).subscribe({
      next: (res) => {
        res.map(b => {
          this.myworldService.getContentBlobObject(b.id, 'countries').subscribe(conObjectResponse => {
            if (conObjectResponse) {
              ...
              b.image_url = url;
               ...
               b.image_url = "assets/img/cards/Countries.png";
              console.log(b);
            }
            this.countries.push(b);
            this.countries = this.countries.sort((a, b) => a.id! - b.id!);
          });
        });
      }
    });
