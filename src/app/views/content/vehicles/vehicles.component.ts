...
export class VehiclesComponent implements OnInit {
  ...
  index(): void {
    ...
    this.contentService.getAllVehicles(accountId).subscribe({
      next: (res) => {
        res.map(b => {
          this.myworldService.getContentBlobObject(b.id, 'vehicles').subscribe(conObjectResponse => {
            if (conObjectResponse) {
              ...
              b.image_url = url;
               ...
               b.image_url = "assets/img/cards/Vehicles.png";
              console.log(b);
            }
