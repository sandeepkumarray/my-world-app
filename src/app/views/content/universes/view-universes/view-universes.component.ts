...
@Component({
  selector: 'app-view-universes',
  templateUrl: './view-universes.component.html',
  styleUrls: ['./view-universes.component.scss']
})
export class ViewUniversesComponent implements OnInit {
  id: any = "";
