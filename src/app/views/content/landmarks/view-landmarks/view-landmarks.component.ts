...
@Component({
  selector: 'app-view-landmarks',
  templateUrl: './view-landmarks.component.html',
  styleUrls: ['./view-landmarks.component.scss']
})
export class ViewLandmarksComponent implements OnInit {
  id: any = "";
