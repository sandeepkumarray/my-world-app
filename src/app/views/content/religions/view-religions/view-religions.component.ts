...
@Component({
  selector: 'app-view-religions',
  templateUrl: './view-religions.component.html',
  styleUrls: ['./view-religions.component.scss']
})
export class ViewReligionsComponent implements OnInit {
  id: any = "";
