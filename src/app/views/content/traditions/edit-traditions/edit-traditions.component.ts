...
@Component({
  selector: 'app-edit-traditions',
  templateUrl: './edit-traditions.component.html',
  styleUrls: ['./edit-traditions.component.css']
})
export class EditTraditionsComponent implements OnInit {
  id: any = "";
  ...
  ngOnInit(): void {
    this.slides[0] = {
      src: './assets/img/cards/Traditions.png',
    };
    this.slides[1] = {
