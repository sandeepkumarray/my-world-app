...
@Component({
  selector: 'app-view-creatures',
  templateUrl: './view-creatures.component.html',
  styleUrls: ['./view-creatures.component.scss']
})
export class ViewCreaturesComponent implements OnInit {
  id: any = "";
