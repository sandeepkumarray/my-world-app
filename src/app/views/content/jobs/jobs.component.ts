...
export class JobsComponent implements OnInit {
  ...
  index(): void {
    ...
    this.contentService.getAllJobs(accountId).subscribe({
      next: (res) => {
        res.map(b => {
          this.myworldService.getContentBlobObject(b.id, 'jobs').subscribe(conObjectResponse => {
            if (conObjectResponse) {
              ...
              b.image_url = url;
               ...
               b.image_url = "assets/img/cards/Jobs.png";
              console.log(b);
            }
            this.jobs.push(b);
