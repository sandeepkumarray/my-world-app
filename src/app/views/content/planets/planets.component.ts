...
export class PlanetsComponent implements OnInit {
  ...
  index(): void {
    ...
    this.contentService.getAllPlanets(accountId).subscribe({
      next: (res) => {
        res.map(b => {
          this.myworldService.getContentBlobObject(b.id, 'planets').subscribe(conObjectResponse => {
            if (conObjectResponse) {
              ...
              b.image_url = url;
               ...
               b.image_url = "assets/img/cards/Planets.png";
              console.log(b);
            }
            this.planets.push(b);
