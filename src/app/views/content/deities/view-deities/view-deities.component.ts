...
@Component({
  selector: 'app-view-deities',
  templateUrl: './view-deities.component.html',
  styleUrls: ['./view-deities.component.scss']
})
export class ViewDeitiesComponent implements OnInit {
  id: any = "";
