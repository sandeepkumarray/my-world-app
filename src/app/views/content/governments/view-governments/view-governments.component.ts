...
@Component({
  selector: 'app-view-governments',
  templateUrl: './view-governments.component.html',
  styleUrls: ['./view-governments.component.scss']
})
export class ViewGovernmentsComponent implements OnInit {
  id: any = "";
