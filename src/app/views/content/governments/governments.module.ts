...
import { GovernmentsRoutingModule } from './governments-routing.module';
...
@NgModule({
  declarations: [
    ...
    ViewGovernmentsComponent,
    EditGovernmentsComponent,
  ],
  imports: [
    CommonModule,
    GovernmentsRoutingModule,AccordionModule,
    BadgeModule,
    BreadcrumbModule,
    ButtonModule,
    CardModule,
